...
target = {
    'before_policy': {                  # 2011
        ...
        'num_firms': scale(115409),            # " count of unique indexes
    ...
    'after_policy': {                   # 2012
        ...
        'num_firms': scale(125259),            # " count of unique indexes
        #'planned_production': None,
...
parameters = {
    'assumptions':
    {
        'setup_period_1': 750,                  # random.randint(1,5)750,
        'setup_period_2': 750,
        'time_before_policy': 189,
        'time_after_policy': 462,
...
upper_limits = {
    'assumptions': {
        ...
        'num_expats': scale(50000000),
        'num_firms': scale(120000),
...
sweep_intervals = {
    'assumptions': {
        ...
        'productivity_std_saudi_pyear': 3,
        'productivity_std_expat_pyear': 3,
        'reapplication_probability_saudi': 3,
        'reservation_wage_mean_saudi': 3,
        'reservation_wage_std_saudi': 3,
        'reservation_wage_mean_expat': 3,
        'reservation_wage_std_expat': 3,
...
def calibration():
    calibration = Kriging(
                        ...
                        dtypes=dtypes,
                        initial_runs=22,
                        db_name='complete_saudi_economy',
                        repetitions=7,
                        )
